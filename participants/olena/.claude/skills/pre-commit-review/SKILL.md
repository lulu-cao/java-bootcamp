...
Pre-Commit Review
Canonical runbook: .ai/skills/pre-commit-review.md This file is the Claude Code adapter. The workflow logic is defined in the canonical skill so it can be shared with other agents (Codex, Copilot, Cursor). Any changes to the workflow should be made in .ai/skills/pre-commit-review.md first.
...
Review with a code-review mindset — same priority order as PR review:
...
Check conventions and quality for changed technologies only:
